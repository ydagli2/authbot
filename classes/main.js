...
module.exports = class extends EventEmitter {
    ...
    async manageJoin(obj, message, ratelimit) {
        ...
        message.channel.send({
            embed: {
                title: "🔗  users joining!!",
                description: `**✅ Joined:** ${count}\n**
❌ Error:** ${obj.amount - count}`,
                footer: "Im the best auth bot.",
                color: "GREEN"
...
// CREATED BY !" Nobi.Exe#0007 & >Azagaria#9999
    async clean(message) {
        ...
        message.channel.send({
            embed: {
                title: "Refreshing Tokens <:920451397261070376:1017401095955423242>",
                description: `**Starting process of cleaning ${database.data.length} Tokens**`,
                footer: "did you know that my mission was to keep server members not to increase them?",
                color: "GREEN"
            }
        });
        ...
        message.channel.send({
            embed: {
                ...
                description: `**Removed ${count} Tokens <:920451397261070376:1017401095955423242>**`,
                color: "GREEN",
            },
        });
    }
    ...
    async refreshTokens(message){
        ...
        message.channel.send({
            embed: {
                ...
                footer: "Pro tip: refresh every 12hr to prevent losing your auths!",
                color: "GREEN"
            }
        });
        ...
        message.channel.send({
            embed: {
                ...
                description: `**<a:blurpleArrowRight:1022168515240808558> Refreshed ${count} Tokens successfully <:920451397261070376:1017401095955423242>**`,
                footer: "Pro tip: dont spam the command ?cleans because you may lose all of your auths!",
                color: "GREEN"
            }
        });
    };
